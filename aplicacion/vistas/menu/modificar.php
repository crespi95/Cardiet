...
echo CHTML::dibujaEtiquetaCierre("div");
echo CHTML::dibujaEtiquetaCierre("div");
echo CHTML::dibujaEtiqueta("p",["id"=>"ayuda","style"=>"text-align:center"],"Añada una palabra descriptiva del alimento o su nombre,
...
echo "Se va a modificar el menu del día <b>".$fila["fecha"]."</b>, compuesto por:<br>
     ".$fila["menu"]."<br>
      Y un consumo total de ".$fila["kcal"]." kcal. <br><hr>";
echo "<br>";
...
echo CHTML::campoLabel("Cantidad: ", "cantidad",["class"=>"col-4 col-md-4 col-sm-5"]);
echo CHTML::campoText("cantidad", "",["placeholder"=>"Cantidad"])." ";
echo CHTML::boton("Añadir",["id"=>"id_1"])."<br>";
...
echo CHTML::modeloHidden($menu, "cod_menu",["value"=>$fila["cod_menu"]]);
...
echo CHTML::modeloError($menu, "menu").
"<br>".PHP_EOL;
...
echo CHTML::modeloText($menu, "fecha",["value"=>$fila["fecha"]]);
